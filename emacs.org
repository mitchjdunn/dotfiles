  ...
  (use-package org
    ...
    (setq org-agenda-files
          '("~/personal/org/Tasks.org"
            "~/personal/org/Habits.org"
            "~/personal/org/Birthdays.org"))
    ...
    (setq org-capture-templates
          `(("t" "Tasks / Projects")
            ("Tt" "Task" entry (file+olp "~/personal/org/Tasks.org" "Inbox")
             "* TODO %?\n  %U\n  %a\n  %i" :empty-lines 1)
            ...
            ("w" "Workflows")
            ("we" "Checking Email" entry (file+olp+datetree "~/personal/orgJournal.org")
             "* Checking Email :email:\n\n%?" :clock-in :clock-resume :empty-lines 1)

            ("m" "Metrics Capture")
            ("mw" "Weight" table-line (file+headline "~/personal/org/Metrics.org" "Weight")
...
#+begin_src emacs-lisp
  ...
  (defun efs/org-babel-tangle-config ()
    (when (string-equal (buffer-file-name)
                        (expand-file-name "~/personal/dotfiles/Emacs.org"))
...
#+end_src
* Applications
Use this format to configure other appilcations with org mode
** Some App
