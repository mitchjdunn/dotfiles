...
#+begin_src emacs-lisp
  ...
  (setq org-agenda-files
	 '("~/org/gtd/inbox.org" "~/org/gtd/projects.org" "~/org/habits.org"))
...
#+RESULTS:
| d | Dashboard       | ((agenda  ((org-deadline-warning-days 7))) (todo NEXT ((org-agenda-overriding-header Next Tasks))) (tags-todo agenda/ACTIVE ((org-agenda-overriding-header Active Projects))))                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |                                                                                                                 |
...
#+RESULTS:
| org-bullets-mode | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-show-all append local] 5] | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-babel-show-result-all append local] 5] | org-babel-result-hide-spec | org-babel-hide-all-hashes | (lambda nil (display-line-numbers-mode 0)) |
...
#+RESULTS:
| #[0 \301\211\207 [imenu-create-index-function org-imenu-get-tree] 2] | (lambda nil (add-hook 'after-save-hook #'mitchymitch/org-babel-tangle-config)) | org-tempo-setup | mitchymitch/org-mode-visual-fill | org-bullets-mode | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-show-all append local] 5] | #[0 \300\301\302\303\304$\207 [add-hook change-major-mode-hook org-babel-show-result-all append local] 5] | org-babel-result-hide-spec | org-babel-hide-all-hashes | mitchymitch/org-mode-setup | (lambda nil (display-line-numbers-mode 0)) |
...
** Plantuml
[[https://www.plantuml.com][PlantUml]] is a documentation tool used to create diagrations with a declarative language.  The below configuration tells emacs where the plantuml jar is located and adds it to org-babel
#+begin_src emacs-lisp
